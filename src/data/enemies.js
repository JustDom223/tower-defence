export const ENEMY_TYPES = {
  runner:   { hp: 60,   speed: 80,  reward: 5,   radius: 10, color: 0xe74c3c },
  sprinter: { hp: 30,   speed: 160, reward: 8,   radius: 8,  color: 0xe67e22 },
  tank:     { hp: 300,  speed: 40,  reward: 20,  radius: 16, color: 0x8e44ad },
  ...
  boss:     { hp: 2000, speed: 22,  reward: 150, radius: 28, color: 0xcc0044 },
};

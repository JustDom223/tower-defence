  ...
  commandpost: {
    ...
    upgrades: {
      pathA: {
        label: 'War Room',
        tiers: [
          { name: 'Combat Drills',    desc: '+20% fire rate and +20% damage to nearby towers',       cost: 150,  stats: { buffFireRate: 0.20, buffDamage: 0.20 } },
          { name: 'Ammo Cache',       desc: '+30% more damage to nearby towers',                     cost: 320,  stats: { buffDamage: 0.30 } },
          { name: 'Extended Network', desc: '+120 range; nearby towers gain +25% range',             cost: 700,  stats: { range: 120, buffRange: 0.25 } },
          { name: 'Supreme Command',  desc: '+50% fire rate, +50% damage to all nearby towers',      cost: 1600, stats: { buffFireRate: 0.50, buffDamage: 0.50 } },
        ],
      },
      pathB: {
        label: 'Recon',
        tiers: [
          { name: 'Surveillance',     desc: 'Fires marking shots — targets take 25% more damage for 3s; loses support aura', cost: 160,  stats: { isSupport: false, buffFireRate: -0.15, fireRate: 0.75, debuffVulnerability: 1.25, debuffDuration: 3.0 } },
          { name: 'Target Lock',      desc: '+25% fire rate; targets take 40% more damage for 5s',  cost: 320,  stats: { fireRate: 0.25, debuffVulnerability: 0.15, debuffDuration: 2.0 } },
          { name: 'Signal Jamming',   desc: 'Marked targets also slowed 30% for 4s',                cost: 700,  stats: { projSlowFactor: 0.70, projSlowDuration: 4.0 } },
          { name: 'Total Disruption', desc: 'Marks 3 targets simultaneously; 60% more damage, 45% slow', cost: 1600, stats: { multiShot: 2, debuffVulnerability: 0.20, projSlowFactor: -0.05 } },
        ],
      },
    },
  },

...
export const WAVES = [
  ...
  [{ type: 'shielded', count: 10, interval: 1.0 },
   { type: 'runner',   count: 14, interval: 0.55 }],

  // Wave 3 — wraith + swarmlings
  [{ type: 'wraith',    count:  4, interval: 2.8 },
   { type: 'swarmling', count: 30, interval: 0.22 }],

  // Wave 4 — regenerator (needs sustained DoT) + tanks
  [{ type: 'regenerator', count:  6, interval: 1.4 },

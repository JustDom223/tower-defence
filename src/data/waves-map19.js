...
export const WAVES = [
  ...
  [{ type: 'armoured',   count: 16, interval: 0.85 },
  ...
  [{ type: 'wraith',   count: 10, interval: 1.7 },
   { type: 'splitter', count: 14, interval: 0.82 },
   { type: 'phantom',  count:  5, interval: 1.0 }],

  // Wave 10 — MEGABOSS + juggernaut + wraith tide
